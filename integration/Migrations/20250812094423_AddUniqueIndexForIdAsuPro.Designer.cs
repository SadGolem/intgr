...
namespace integration.Migrations
{
    ...
    [Migration("20250812094423_AddUniqueIndexForIdAsuPro")]
    partial class AddUniqueIndexForIdAsuPro
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("integration.Domain.Entities.ScheduleEntity", b =>
                {
                    b.HasOne("EmitterEntity", "Emitter")
                        .WithMany("Schedules")
                        .HasForeignKey("EmitterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("integration.Domain.Entities.LocationEntity", "Location")
                        .WithMany("Schedules")
