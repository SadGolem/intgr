...
public class ScheduleGetterServiceFactory : IGetterServiceFactory<ScheduleData>
{
    ...
    public ScheduleGetterServiceFactory(
        ...
        IScheduleStorageService scheduleStorageService, IContractPositionStorageService contractPositionStorageService,
    ...
    {
        return new ScheduleGetterService(_httpClientFactory, _httpClient, _logger, _configuration, _scheduleStorageService, _contractPositionStorageService, _tokenService);
    }
}