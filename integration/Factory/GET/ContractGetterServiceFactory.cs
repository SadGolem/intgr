...
public class ContractGetterServiceFactory : IGetterServiceFactory<ContractData>
{
    ...
    public ContractGetterServiceFactory(
        ...
        IConfiguration configuration, IConverterToStorageService converterToStorageService, IContractPositionStorage contractPositionStorage, IContractStorageService contractStorageService)
    {
    ...
    {
        return new ContractGetterService(_httpClientFactory, _httpClient, _logger, _configuration, _contractPositionStorage, _contractStorageService);
    }
}