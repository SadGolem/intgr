...
public class ClientGetterServiceFactory : IGetterServiceFactory<ClientData>
{
    ...
    public ClientGetterServiceFactory(
        ...
        IClientStorageService storageClientService, ITokenService tokenService)
    {
    ...
    {
        return new ClientGetterService(_httpClientFactory, _httpClient, _logger, _configuration, _contractPositionStorageService, _storageClientService, _tokenService);
    }
}