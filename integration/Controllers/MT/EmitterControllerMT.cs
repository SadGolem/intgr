...
namespace integration.Controllers.MT
{
    ...
    public class EmitterControllerMT : ControllerBase
    {
        ...
        public EmitterControllerMT(ILogger<EmitterControllerMT> logger, IHttpClientFactory httpClientFactory,
            IConfiguration configuration, TokenController tokenController)
        {
            _logger = logger;
