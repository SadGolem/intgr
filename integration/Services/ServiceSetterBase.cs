...
public class ServiceSetterBase<T> : ServiceBase
{
    ...
    public ServiceSetterBase(IHttpClientFactory httpClientFactory, HttpClient httpClient, ILogger<ServiceBase> logger, IConfiguration configuration, ITokenService tokenService) : base(httpClientFactory, httpClient, logger, configuration,  tokenService)
    {
        _logger = logger;
    }
