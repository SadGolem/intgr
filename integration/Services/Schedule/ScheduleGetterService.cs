...
public class ScheduleGetterService : ServiceBase, IGetterService<ScheduleData>
{
    ...
    public ScheduleGetterService(IHttpClientFactory httpClientFactory, HttpClient httpClient,
        ILogger<ScheduleGetterService> logger, IConfiguration configuration, IScheduleStorageService scheduleStorageService, 
        IContractPositionStorageService contractPositionStorageService, ITokenService tokenService)
        : base(httpClientFactory, httpClient, logger, configuration, tokenService)
    {
