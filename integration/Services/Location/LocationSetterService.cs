...
namespace integration.Services.Location
{
    public class LocationSetterService : ServiceBase, ISetterService<LocationData>
    {
        ...
        public LocationSetterService(IHttpClientFactory httpClientFactory, HttpClient httpClient, ILogger<LocationSetterService> logger, IConfiguration configuration, ITokenService tokenService) : base(httpClientFactory, httpClient, logger, configuration, tokenService)
        {
