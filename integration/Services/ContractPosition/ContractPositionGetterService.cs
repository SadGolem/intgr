...
public class ContractPositionGetterService(
    ...
    ILocationIdService locationIdService, IContractPositionStorageService contractPositionStorageService, ITokenService tokenService)
    : ServiceGetterBase<ContractPositionData>(httpClientFactory, httpClient, logger, configuration, tokenService),
